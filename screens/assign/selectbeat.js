  ...
  return (
    <SafeAreaView className="w-screen">
      <ScrollView className=" w-screen">
        ...
        <View className="my-5 mx-5 bg-slate-200 flex rounded-2xl px-5 py-10">
          {beatData?.map((beat, id) => (
            <View
              ...
              <View className="flex flex-row gap-1">
                ...
                <Text className="text-black font-bold"> Beat: {beat.beat}</Text>
                <Text className="text-black">{beat.officer_id}</Text>
                <Text className="text-black">{beat.Officer_name}</Text>
              </View>
              <View>
                {beat?.officer_id === '' ? (
                  <Icon
